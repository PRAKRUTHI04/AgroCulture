                ...
                <section>
                    ...
                    <form method="post" action="Login/signUp.php">
                        <center>
                            ...
                            <div class="row uniform">
                                <div class="3u 12u$(xsmall)">
                                    <input type="text" name="addr" id="addr" value="" placeholder="Address" class="addr" style="width:600px;height:60px;" required/>
                                </div>
                            </div>
                            <div class="row uniform">
                                <div class="3u 12u$(xsmall)">
                                    <input type="text" name="aadhaar" id="aadhaar" value="" class="aadhaar-input" style="width: 600px;" placeholder="Aadhaar Number" required/>
                                </div>
                            </div>
                            <div class="row uniform">
                                <p>
