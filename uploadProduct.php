...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $productAvailability = dataFilter($_POST['availability']);
    $fid = $_SESSION['id'];

    $sql = "INSERT INTO fproduct (fid, product, pcat, pinfo, price, availability)
            VALUES ('$fid', '$productName', '$productType', '$productInfo', '$productPrice', '$productAvailability')";
    ...
    <section id="one" class="wrapper style1 align-center">
        <div class="container">
            <form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <input type="text" name="price" id="price" value="" placeholder="Price per kg" style="background-color:white;color: black;" />
                    </div>
                    <div class="col-sm-4">
                        <input type="number" name="availability" id="availability" value="" placeholder="Availability" style="background-color:white;color: black;" />
                    </div>
                    <div class="col-sm-4">
